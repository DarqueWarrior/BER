namespace BerService.Controllers
{
   ...
   /// <summary>
   /// The main controller of the BER service. Allows you following methods
   /// Get: Retrieve record
   /// Post: Add record
   ...
   public class RecordsController : ControllerBase
   {
      ...
      [HttpGet(Name = "RecordList")]
      public IActionResult List()
      {
         try
         {
            _logger.LogInformation($"Listing records.");
         ...
         return BadRequest("Could not list records");
      }
